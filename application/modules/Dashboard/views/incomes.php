...
<div id="content" class="content">
    ...
    <h2 class="page-titel">
        <span style="font-size:20px">Bonus </span> /  <?php echo $header; ?> $<?php echo $total_income['total_income']; ?>
    </h2>
        ...
        <div class="wizard-content tab-content">
            ...
            <div class="tab-pane active show" id="tabFundRequestForm">
                ...
                <div class="row">
                    <!-- BEGIN col-6 -->
                    <div class="col-md-12">
                        <table class="table table-bordered table-striped dataTable" id="tableView" data-date_col="5">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>User ID</th>
                            ...
                            <tbody>
                                ...
                                foreach ($user_incomes as $key => $income) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date("m/d/Y", strtotime($income['created_at'])); ?></td>
                                    </tr>
                                    <?php
                                }
                                ?>
