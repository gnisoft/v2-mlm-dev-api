                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="row">
                                        <select class="form-control" id="bnktoggle">
                                            ...
                                            <option data-tab="bankform">Bank Details</option>
                                            <option data-tab="paypalForm">Paypal</option>
                                            <option data-tab="btcForm">BTC</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <?php echo form_close(); ?>
                                    <?php echo form_open_multipart(base_url('Dashboard/user/btc_update'), array('id' => 'btcForm', 'style' => 'display:none;', 'class' => 'pswrdrst bnkfrm')); ?>
                                    <h4 class="panel-title text-center">BTC Details</h4>
                                    <div class="card-block">
                                        <div id="edit-contact-info" class="row" style="">
                                            <div class="form-group col-md-12">
                                    ...
                                    <?php echo form_close(); ?>
                                    <?php echo form_open_multipart(base_url('Dashboard/user/paypal_update'), array('id' => 'paypalForm', 'style' => 'display:none;', 'class' => 'pswrdrst bnkfrm')); ?>
                                    <h4 class="panel-title text-center">Paypal Details</h4>
                                    <div class="card-block">
                                        <div id="edit-contact-info" class="row" style="">
                                            <div class="form-group col-md-12">
                                                <label class="col-md-12">Paypal Id
                                                    <span class="text-c-pink">*</span>
                                                </label>
                                                <div class="col-md-12">
                                                    <input type="email" class="form-control form-control-line"  value="<?php echo $user_bank->paypal; ?>" placeholder="Paypal" name="paypal" required="" >
                                                </div>
                                            </div>
                                            <div class=" form-group col-md-12 text-center m-t-20">
                                                <div class="loader">
